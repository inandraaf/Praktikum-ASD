...
#melakukan dua implementasi algoritma pengurutan yaitu Merge Sort dan Quick Sort untuk mengurutkan
#daftar NIM dari objek-objek mahasiswa yang diinisialisasi sebagai instansi dari kelas MhsTIF.
...
#untuk membandingkan waktu eksekusi dari lima algoritma pengurutan berbeda (Bubble Sort, Selection Sort,
#Insertion Sort, Merge Sort, dan Quick Sort) pada sebuah daftar yang terdiri dari 6000 elemen acak.
...
#menerapkan algoritma Merge Sort dengan menggunakan dua fungsi utama: _merge_sort untuk membagi daftar 
#secara rekursif dan sort_sub_list untuk menggabungkan sub-daftar yang telah diurutkan.
...
print('sorted:')
print(liste1)
#mengimplementasikan algoritma Quick Sort dengan opsi untuk mengurutkan daftar dalam urutan 
#naik (ascending) atau turun (descending).
...
#mengimplementasikan dan membandingkan kinerja dari berbagai versi algoritma Merge Sort dan Quick Sort,
#termasuk versi modifikasi yang menggunakan teknik median-of-three untuk memilih pivot. 
#Hasil waktu eksekusi dicetak untuk setiap versi algoritma untuk membantu menentukan mana yang 
#lebih efisien pada daftar acak berisi 6000 elemen
...
print("Merged List :"),
list3.printList()
#menunjukkan cara membangun, menambah elemen, mencetak, dan menggabungkan dua daftar
#berantai yang terurut menggunakan struktur data Linked List di Python.